<template>
  <div class="ratingselect">
    <div class="rating-type border-1px">
      ...
      <span @click="select(1)" class="block positive" :class="{'active': selectType === 1}">{{desc.negative}}<span class="count">{{negatives.length}}</span></span>
    </div>
...
<style lang="scss">
  ...
  .ratingselect {
    .rating-type {
      padding: 18px 0;
      margin: 0 18px;
      @include border-1px(rgba(0, 17, 27, .1));
      font-size: 0;
      .block {
